...
class TestGithubOrgClient(unittest.TestCase):
    ...
    def test_org(self, org_name, mock_get_json):
        """Test that GithubOrgClient.org calls get_json with URL."""
    ...
    def test_public_repos(self, mock_get_json):
        ...
        with patch(
            ...
            mock_repos_url.return_value = "http://test_repos_url.com"
            client = GithubOrgClient("test")
            self.assertEqual(client.public_repos(), ["repo1", "repo2"])
            mock_repos_url.assert_called_once()
            mock_get_json.assert_called_once_with("http://test_repos_url.com")
...
class TestIntegrationGithubOrgClient(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        """Patch requests.get so get_json reads fixtures in order."""
    ...
    def test_public_repos(self):
        """Integration: public_repos returns expected repo names."""
        client = GithubOrgClient("google")
        self.assertEqual(client.public_repos(), self.expected_repos)

    def test_public_repos_with_license(self):
        """Integration: public_repos with license filter."""
        client = GithubOrgClient("google")
        self.assertEqual(
    ...
    def test_public_repos_with_license(self):
        """Integration: public_repos filters repos by apache-2.0 license."""
        client = GithubOrgClient("google")
        self.assertEqual(
            client.public_repos(license="apache-2.0"),
            self.apache2_repos
